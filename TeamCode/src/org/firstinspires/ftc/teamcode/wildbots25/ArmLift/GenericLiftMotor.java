...
public class GenericLiftMotor {
    ...
    //DcMotorEx would also allow us to easily impelement PID coeffients if we wanted to get really fancy
    ...
    GenericLiftMotor(DcMotorEx motor, double powerUsed, int tolerance){
        this.motor = motor;
